package de.telran.homeWork.hw_17.sendMessage;

public class Main {
/*Написать приложение для рассылки уведомлений о проведении платежа в банке
по нескольким каналам передачи данных Telegram, Viber, WhatsApp, E-Mail.
